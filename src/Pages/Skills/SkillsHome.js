...
function SkillsHome() {
  ...
  return (
    <div className={`${darkMode && 'bg-red-600'} transition-colors duration-500 md:mt-24 py-16 px-10 md:px-20`}>
        <nav  className={`${darkMode && 'text-yellow-400'} text-3xl md:text-6xl font-bold`}>skills and Interests.</nav>
